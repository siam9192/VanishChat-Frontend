...
function OwnMessageBubble({message}:IProps) {
  return (
    <div className="mt-5  flex justify-end">
      <div className="">
        <p className="text-sm text-end">
          By me <span className="dark:text-gray-500 text-gray-800 text-[.6rem]">at {new Date(message.createdAt).toLocaleTimeString()}</span>
        </p>
