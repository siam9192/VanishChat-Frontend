...
function ChatRoom() {
  return (
    <div className="h-screen grid grid-cols-8">
      ...
      <div className="col-span-2 overflow-y-auto p-5 hide-scrollbar border-l-2 border-gray-800">
        <div>
          <img
          ...
          />
          <h2 className="text-xl text-white  font-medium text-center mt-2">Friends secret zone</h2>
        </div>
        <div className="mt-10">
